...
setup(
    name="MaBoSSG_BB",
    version="0.0.1",
    description="This package provides the MaBoSSG Building Block",
    ...
    keywords="BuildingBlock, PerMedCoE, MaBoSSG",
    package_dir={"": "src"},
    ...
    entry_points={
        "console_scripts": [
            "MaBoSSG_BB=MaBoSSG_BB.__main__:main",
        ],
    },
    project_urls={
        "Bug Reports": "https://github.com/PerMedCoE/BuildingBlocks/issues",
        "Source": "https://github.com/PerMedCoE/BuildingBlocks/tree/main/MaBoSSG",
    },
)
