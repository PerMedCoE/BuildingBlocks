...
from build_model_from_species_BB.definitions import BUILD_MODEL_FROM_SPECIES_ASSETS
from build_model_from_species_BB.definitions import COMPUTING_UNITS

# Globals
BUILD_MODEL_FROM_SPECIES_BINARY = os.path.join(BUILD_MODEL_FROM_SPECIES_ASSETS, "FromSpeciesToMaBoSSModel.sh")
