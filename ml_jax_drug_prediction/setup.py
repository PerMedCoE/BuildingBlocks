...
setup(
    name="ml_jax_drug_prediction_BB",
    version="0.0.1",
    description="This package provides the ML Jax Drug Prediction Building Block",
    ...
    keywords="BuildingBlock, PerMedCoE, ml_jax_drug_prediction",
    package_dir={"": "src"},
    ...
    project_urls={
        ...
        "Source": "https://github.com/PerMedCoE/BuildingBlocks/tree/main/ml_jax_drug_prediction",
    },
)
